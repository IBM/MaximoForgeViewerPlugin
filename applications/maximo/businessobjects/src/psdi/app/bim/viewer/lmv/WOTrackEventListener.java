 ...
 * @author Doug Wood
 */
public class WOTrackEventListener implements EventListener
{
	public WOTrackEventListener()
	{
	}
		...
		throws MXException
	{
		...
		try
		{
			...
			{
				MboSetRemote workViewSet = mbo.getMboSet( WorkView.RELATIONSHIP_WORKVIEWS );
				workViewSet.deleteAll();
				workViewSet.save();
				getLogger().info( "WOTraceEventListener Event " + em.getEventName() + " has been fired for mbo "
	...
	{
		return MXLoggerFactory.getLogger("maximo.mbo.wotrack"  );
	}
