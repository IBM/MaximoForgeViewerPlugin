...
public class BucketSet extends MboSet implements BucketSetRemote 
{
	private boolean _fetchFromForge = true;
	...
	{
		return new Bucket(ms);
	}

	public boolean isFetchFromForge()
	{
		return _fetchFromForge;
	}

	public void setFetchFromForge(
	    boolean fetchFromForge )
	{
		_fetchFromForge = fetchFromForge;
	}
}
