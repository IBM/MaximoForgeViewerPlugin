...
public class BucketDeleteApproveSet extends NonPersistentMboSet implements BucketDeleteApproveSetRemote 
{
     ...
     */
	public BucketDeleteApproveSet(MboServerInterface ms) 
	...
	{
		return new BucketDeleteApprove(ms);
	}
}
