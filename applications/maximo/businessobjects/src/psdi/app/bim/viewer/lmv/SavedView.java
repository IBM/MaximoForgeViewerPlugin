       ...
       implements SavedViewRemote
{
	...
	public final static String RELATIONSHIP_SAVEDVIEWS = "SAVEDVIEWS";		// Saved views associated with a BuildingModel
   	
   	public final static String FIELD_BIMLMVSAVEDVIEWID = "BIMLMVSAVEDVIEWID"; 
	...
	public final static String FIELD_SHARED            = "SHARED"; 
	...
	*/
	 ...
	 */
	public SavedView(MboSet ms) throws RemoteException
	{
		super(ms);
	}
