...
public class ViewableDeregister
{

	private DataRESTAPI _service;
	public ViewableDeregister()
	{
	...
	public Result deregister(
		...
		throws IOException, 
			   URISyntaxException 
	{
		return _service.viewableDeregister( urn );
	}
		   ...
		   URISyntaxException 
	{
		if( arg.length < 1 )
		{
			System.out.println( "Usage: dereigster urn" );
			return;
		}
		ViewableDeregister deregister = new ViewableDeregister();
		
		Result result = deregister.deregister( arg[0] );
